...
fn keyword_starting_identifier_lexes() {
    let string = "programmatically doable variable ofloaded asserted endofunctors";
    assert_eq!(
        Ok((
           vec![
                tok(Identifier(String::from("programmatically")), (0, 0), (0, 16)),
                tok(Identifier(String::from("doable")), (0, 17), (0, 23)),
                tok(Identifier(String::from("variable")), (0, 24), (0, 32)),
                tok(Identifier(String::from("ofloaded")), (0, 33), (0, 41)),
                tok(Identifier(String::from("asserted")), (0, 42), (0, 50)),
                tok(Identifier(String::from("endofunctors")), (0, 51), (0, 63)),
            ],
            "",
            string.len()
        )),
    ...
    assert_eq!(
        Ok((
           vec![
                ...
                tok(Operator(Substraction), (0, 2), (0, 3)),
                tok(Operator(Multiplication), (0, 4), (0, 5)),
                tok(Operator(Division), (0, 6), (0, 7)),
                tok(Operator(And), (0, 8), (0, 11)),
                tok(Operator(Or), (0, 12), (0, 14)),
                tok(Operator(Not), (0, 15), (0, 18)),
                tok(Operator(Equality), (0, 19), (0, 20)),
                tok(Operator(LessThan), (0, 21), (0, 22)),
                tok(Operator(LessThanEqual), (0, 23), (0, 25)),
                tok(Operator(GreaterThanEqual), (0, 26), (0, 28)),
                tok(Operator(GreaterThan), (0, 29), (0, 30)),
                tok(Operator(Inequality), (0, 31), (0, 33)),
            ],
            "",
            33
        )),
